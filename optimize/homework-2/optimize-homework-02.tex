...
\begin{enumerate}
    ...
    \item Leaving variable: \( s_1 \) (minimum ratio test: \( 5/2 = 2.5 \)).
    \item Pivot on \( (3,1) \) to update tableau.
\end{enumerate}
\[
...
\begin{array}{c|ccccc|c}
    \text{Basis} & x_1 & x_2 & s_1 & s_2 & s_3 & \text{RHS} \\
    \hline
    s_1 & 0 & \frac{1}{2} & \textcolor[HTML]{0000FF}{1} & 0 & -\frac{1}{2} & \frac{1}{2} \\
    s_2 & 0 & \frac{3}{2} & 0 & \textcolor[HTML]{0000FF}{1} & -\frac{1}{2} & \frac{5}{2} \\
    x_1 & \textcolor[HTML]{0000FF}{1} & \frac{1}{2} & 0 & 0 & \frac{1}{2} & \frac{5}{2} \\
    \hline
    z & 0 & -\frac{1}{2} & 0 & 0 & \frac{1}{2} & \frac{5}{2} \\
\end{array}
\]

Continuing from the previous tableau, \( (x_1, x_2, s_1, s_2, s_3) = (\frac{5}{2}, 0, \frac{1}{2}, \frac{5}{2}, 0) \).
\begin{enumerate}
    \item Entering variable: \( x_2 \) (most negative in \( z \)-row).
    \item Leaving variable: \( s_1 \) (minimum ratio test: \( \frac{1}{2} / \frac{1}{2} = 1 \)).
    \item Pivot on \( (1,2) \) to update tableau.
\end{enumerate}
\[
\renewcommand{\arraystretch}{1.3}
\begin{array}{c|ccccc|c}
    \text{Basis} & x_1 & x_2 & s_1 & s_2 & s_3 & \text{RHS} \\
    \hline
    x_2 & 0 & \textcolor[HTML]{0000FF}{1} & 2 & 0 & -1 & 1 \\
    s_2 & 0 & 0 & -3 & \textcolor[HTML]{0000FF}{1} & -2 & 1 \\
    x_1 & \textcolor[HTML]{0000FF}{1} & 0 & -1 & 0 & 1 & 2 \\
    \hline
    z & 0 & 0 & 1 & 0 & 0 & 3 \\
\end{array}
\]
...
\[ \boxed{(x_1, x_2) = (2, 1) \text{ with }z = 8}. \]
\end{solution}
% ================================================================================ %
...
Since the value of pivot in this BFS is \( x_1 = s_2 = 4 \).
This equality indicates that there are multiple optimal solutions along the line segment between the points \( (4, 0) \) and \( (0, 4) \).
As a result, this LP can be considered degenerate.

\vspace{2mm}

We can check this by:
\begin{enumerate}
    \item Entering variable: \( x_2 \).
    \item Leaving variable: \( s_2 \) (to make both \( x_1,  x_2 \) basic variables).
...
\begin{array}{c|cccc|c}
    \text{Basis} & x_1 & x_2 & s_1 & s_2 & \text{RHS} \\
    \hline
    x_1 & \textcolor[HTML]{0000FF}{1} & 0 & 2 & -1 & 0 \\
    x_2 & 0 & \textcolor[HTML]{0000FF}{1} & -1 & 1 & 4 \\
    \hline
    z & 0 & 0 & 3 & 0 & 4 \\
\end{array}
\]
...
\begin{array}{c|cccccc|c}
    ...
    a_1 & \frac{2}{3} & \textcolor[HTML]{0000FF}{1} & 0 & 0 & -\frac{20}{3} & 1 & 20 \\
    \hline
