...
\begin{align*}
    ...
    &= \paren{ \frac{1}{3} }^n u[n] + \sum_{k=-\infty}^{\infty} \paren{ \frac{1}{3} }^k u[k] \paren{ \frac{1}{2} }^{n - k} u[n - k] \\
...
\begin{itemize}
    ...
    \begin{align*}
        ...
        &= \paren{ \frac{1}{3} }^n + \paren{ \frac{1}{2} }^n \cdot (3) \paren{ 1 - \paren{ \frac{2}{3} }^{n + 1} } \\
        &= \paren{ \frac{1}{3} }^n + \paren{ \frac{1}{2} }^n \cdot (3) \paren{ 1 - \paren{ \frac{2}{3} }^{n} \paren{ \frac{2}{3} } } \\
        &= \paren{ \frac{1}{3} }^n + \paren{ \frac{1}{2} }^n \paren{ 3 - 2\paren{ \frac{2}{3} }^{n} } \\
